...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener{
    ...
    protected TextView caiwu;


    protected TextView touzhu;
    ...
    protected void initView() {
        ...
        benju = (TextView) getView().findViewById(R.id.benju);
        guanli = (TextView) getView().findViewById(R.id.guanli);
        touzhu = (TextView) getView().findViewById(R.id.touzhu);
